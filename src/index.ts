...
export = (app: Probot) => {
  ...
  app.on("issues.labeled", async (context) => {
    ...
    if (issueItemStatus == "🏗 In progress" && label == "stale") {
    ...
    } else if (issueItemStatus == "🏗 In progress" && label == "inactive") {
      ...
      console.log('Label is not stale or inactive. Nothing to do for label "' + label + '".');
    }
  });
